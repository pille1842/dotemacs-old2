...
** Personal files
The agenda draws items like tasks, events etc. from a list of Org files. In my case, these reside in =~/org/=. Anything in there should be eligible for the agenda.
